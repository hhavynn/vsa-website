...
2. **Archive last year's Houses.** Legacy-House machinery: `src/data/legacyHouseArchive.ts` (+ its test, one of only three test files), seed migrations `20260531000000_seed_legacy_house_assets.sql` and `20260601010000_restore_mario_house_assets.sql`, membership history `20260525000000_add_house_membership_history.sql`.
