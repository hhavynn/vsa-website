...
# Acceptable: exits 0, all suites pass. As of 2026-07-06 there are 3 test files:
# src/App.test.tsx, src/data/legacyHouseArchive.test.ts, src/utils/seasonalState.test.ts.
