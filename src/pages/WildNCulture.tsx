...
const faqs = [
  { q: "What is Wild N' Culture?", a: "Wild N' Culture (WNC) is VSA at UCSD's annual intercollegiate comedy competition - inspired by Wild 'N Out and rooted in Vietnamese and Asian American culture. Schools face off in a series of live improv-style games and roast battles judged by the crowd and guest judges." },
        ...
        <section className="program-section">
          <div className="program-section-inner program-section-narrow">
            ...
            <p className="program-body">
              Wild N' Culture is VSA at UCSD's annual intercollegiate comedy competition. Inspired by Wild 'N Out, it brings together Vietnamese Student Associations and Asian American student groups from across Southern California for a night of live improv-style games, roast battles, and pure crowd energy.
            </p>
            <p className="program-body">
