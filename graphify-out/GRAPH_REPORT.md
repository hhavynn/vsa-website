# Graph Report - vsa-website  (2026-07-03)

## Corpus Check
- 338 files · ~1,705,684 words
...
Cohesion: 0.04
Nodes (48): Ace, AdminAceFamilies, AdminAiFeedback, AdminAiKnowledge, AdminAnalytics, AdminApplications, AdminCabinet, AdminContent (+40 more)
...
Cohesion: 0.33
Nodes (5): Safety / Scope, Screenshots / Notes, Summary, Type, Verification
...
Cohesion: 0.40
Nodes (4): Curated vs. dynamic, Data rules (privacy), Future version (not built in this MVP), VSA Wrapped / Year in Review (`/wrapped`)

### Community 71 - "Community 71"
Cohesion: 0.08
Nodes (24): Apply mode, Categories, Cautions, Dry run (safe, read-only), Event Image Migration, House Event Automation, How it works, How to run (+16 more)
...
Cohesion: 0.09
Nodes (12): allowedOrigins, AssistantStatus, corsHeaders(), countUsage(), expandQuerySynonyms(), getRateLimitReason(), jsonResponse(), KnowledgeSnippet (+4 more)
...
Cohesion: 0.40
Nodes (3): Props, STICKER_CLASS, StickerTone
...
Cohesion: 0.13
Nodes (15): scripts, analyze, analyze:all, analyze:css, build, build:production, eject, format (+7 more)

### Community 115 - "Community 115"
Cohesion: 0.14
Nodes (13): Calling Graphify from Subagents and Hooks, Graphify Developer Workflow, Hook Auto-Update, How Claude Uses Graphify, How Codex Uses Graphify, If Graphify Is Not Installed, Important Reminder, Installation (+5 more)

### Community 116 - "Community 116"
Cohesion: 0.14
Nodes (13): Admin workflow (`/admin/photo-requests`), Applying to production, Critical Product Rule: No Member Login, Data model (`20260701000000_add_member_photo_requests.sql`), Member-facing flow, `member_photo_request_events`, `member_photo_requests`, Member Photo Requests: Identity/Avatar System with Admin Approval (+5 more)

### Community 118 - "Community 118"
Cohesion: 0.15
Nodes (12): Allowed work, Audit-first checklist, Domain summary, Expected verification, Key rules, Likely files, Manual QA expectations, Out of scope (+4 more)

### Community 119 - "Community 119"
Cohesion: 0.15
Nodes (12): Allowed work, Audit-first checklist, Domain summary, Expected verification, Important rules, Likely files, Manual QA expectations, Out of scope (+4 more)

### Community 120 - "Community 120"
Cohesion: 0.15
Nodes (12): Allowed work, Audit-first checklist, Domain summary, Expected verification, Likely files, Manual QA expectations, Notes, Out of scope (+4 more)
...
Cohesion: 0.17
Nodes (11): Allowed work, Audit-first checklist, Domain summary, Expected verification, Key rules, Likely files, Manual QA expectations, Out of scope (+3 more)
...
Cohesion: 0.17
Nodes (11): Allowed work, Audit-first checklist, Correct House year mapping (authoritative), Domain summary, Expected verification, Likely files, Manual QA expectations, Out of scope (+3 more)

### Community 127 - "Community 127"
Cohesion: 0.17
Nodes (11): Allowed work, Audit-first checklist, Domain summary, Expected verification, Key rules, Likely files, Manual QA expectations, Out of scope (unless the task EXPLICITLY asks, with acceptance criteria + tests) (+3 more)
...
Cohesion: 0.17
Nodes (11): Allowed work, Audit-first checklist, Domain summary, Expected verification, Hard rules, Likely files, Manual QA expectations, Out of scope (+3 more)

### Community 131 - "Community 131"
Cohesion: 0.18
Nodes (10): Allowed work, Audit-first checklist, Domain summary, Expected verification, Likely files, Manual QA expectations, Out of scope, Safety notes (+2 more)
...
Cohesion: 0.18
Nodes (10): 1. Database Schema (`cabinet_members`), 2. Storage Bucket, 3. Frontend Routes & Navigation, 4. Admin API Handlers (Supabase Client methods), API / Interface Definitions, Cabinet Management Feature - Architecture Design, Edge Cases & Limitations, Problem Statement (+2 more)

### Community 134 - "Community 134"
Cohesion: 0.18
Nodes (10): browserslist, development, production, eslintConfig, extends, jest, transformIgnorePatterns, name (+2 more)

### Community 135 - "Community 135"
Cohesion: 0.20
Nodes (9): Audit/review-only vs. edit-capable, Claude Subagent Workflow (VSA Website), How to ask Claude to use a specific subagent, How to review the subagent's output, How to write a good scoped task, Safety checklist before accepting code changes, The VSA subagents, What Claude subagents are here (+1 more)

### Community 136 - "Community 136"
Cohesion: 0.20
Nodes (9): 1. Dry Run (Safe), 2. Apply Migration, GitHub Actions, House Profile Image Migration, Manual Migration, Required Environment Variables, Script Flags, Storage Structure (+1 more)

### Community 137 - "Community 137"
Cohesion: 0.20
Nodes (9): Admin Operations, Attendance Import, Calculation Logic, Data Source, Future Considerations, Key Tables & Views, Member Management, Overview (+1 more)

### Community 138 - "Community 138"
Cohesion: 0.20
Nodes (8): Gemini Playbook Routing, graphify (Auto-Generated), Graphify Query-First Workflow, High-Risk Protected Systems, Mandatory Startup Workflow, PR Workflow, Project Identity, Verification
...
Cohesion: 0.22
Nodes (8): 1. System Architecture, 2. Privacy & Data Guardrails, 3. Safe Link Rendering, 4. Fallback Mechanics, Ask VSA AI Assistant Architecture & Privacy, Edge Function Safety Interceptors, Hashed Usage Logging (No PII), System Prompt Constraints

### Community 142 - "Community 142"
Cohesion: 0.22
Nodes (8): 1. Discovery (Graphify Query-First), 2. Domain Context (Playbook Routing), 3. Safety and Constraints, Gemini CLI Workflow, Graphify Integration, Parity with Claude/Codex, Verification Checklist, Workflow Overview
...
Cohesion: 0.22
Nodes (9): devDependencies, autoprefixer, postcss, prettier, react-scripts, sharp, source-map-explorer, tailwindcss (+1 more)
...
Cohesion: 0.25
Nodes (7): Automated changes, Data-rights anonymization runbook, Intentionally preserved, Manual and deferred work, Post-migration SQL checks, Required order, Rollback and incident response
...
Cohesion: 0.29
Nodes (6): Common Pitfalls, Dynamic Content Routing Audit, Dynamic Content Source Map, Public/Admin Route Map, QA Checklist, What Not To Touch Without Separate Approval
...
Cohesion: 0.33
Nodes (5): Admin Analytics Setup, Deploy the function, Frontend analytics measurement ID, Google Analytics access checklist, Required Supabase Edge Function secrets

### Community 158 - "Community 158"
Cohesion: 0.33
Nodes (5): Academic Terms, Admin Content Management, Cabinet Years, Future Board Workflow, Notes

### Community 159 - "Community 159"
Cohesion: 0.33
Nodes (5): Asking Codex to use a playbook, Audit-first domains, Codex VSA Playbook Workflow, Quick reference, Reviewing Codex output

### Community 160 - "Community 160"
Cohesion: 0.33
Nodes (5): Admin Import (/admin/import), Admin Members (/admin/members), Admin Points (/admin/points), Public Leaderboard (/leaderboard), Yearly Leaderboard Test Checklist
...
Cohesion: 0.40
Nodes (4): After generation, SCREEN 1 — Member Roster, SCREEN 2 — Admin Points Dashboard, Stitch Generation Prompts — VSA Editorial Design System
